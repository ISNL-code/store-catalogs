...
export const ALBERTO_BINI_KZ_OUTLET = {
    storage_key: 'ab_kz-outlet',
    active: false,
    required_registration: false,
    URL: ['https://albertobini-kz-oulet.netlify.app'],
    web_lang: 'ru', // html lang
    store_name: 'Alberto Bini KZ Outlet',
    ...
    links: [
        ...
        {
            name: 'Retail',
            href: 'https://albertobini-kz-retail.netlify.app/store/ALBERTO_BINI',
            description: 'Retail',
            type: 'WEB',
        },
    ],
