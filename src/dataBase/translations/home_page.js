export const HOME_PAGE = {
    en: {
        ...
        customer_description_1: `Our factory, with over 10 years of history, is renowned for its quality and reliability. We sell our products worldwide, constantly striving for perfection to ensure every customer is satisfied. Trust our experience and traditions!`,
        customer_description_2: `We offer favorable terms for wholesale buyers. Our assortment is ideal for large retail chains and stores. Become our partner and receive special offers!`,
        customer_description_3: `We offer convenient terms for retail customers. A wide selection of fashionable clothing is available to everyone. Shop with us and enjoy quality and style!`,
        customer_description_4: `Our portfolio includes a wide range of styles for all ages and preferences. We regularly update our assortment to reflect the latest fashion trends. Find your perfect look with us!`,
        customer_description_5: `We guarantee the high quality of each item, using only durable and fashionable materials. Your purchase will look elegant and last a long time. Choose quality!`,
    },
    fr: {
    ...
    ua: {
        ...
        customer_description_3: `Ми пропонуємо зручні умови для роздрібних клієнтів. Широкий вибір модного одягу доступний кожному. Робіть покупки у нас і насолоджуйтеся якістю та стилем!`,
