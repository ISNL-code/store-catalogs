export const HOME_PAGE = {
    en: {
        ...
        customer_title_6: 'Extensive Collection',
        customer_title_4: 'Visit our Outlet Store',
        ...
        customer_description_4:
            "Visit our outlet store for exclusive deals and discounts. Experience our high-quality products firsthand and find great bargains on your favorite styles. Don't miss out on our special offers!",
    },
    fr: {
        ...
        customer_title_6: `Collection Étendue`,
        customer_title_4: `Visitez notre Magasin d'Usine`,
        ...
        customer_description_6: `Notre portefeuille comprend une large gamme de styles pour tous les âges et toutes les préférences. Nous mettons régulièrement à jour notre assortiment pour refléter les dernières tendances de la mode. Trouvez votre look parfait chez nous!`,
        ...
        customer_description_4: `Visitez notre magasin d'usine pour des offres et des réductions exclusives. Découvrez nos produits de haute qualité en personne et trouvez de bonnes affaires sur vos styles préférés. Ne manquez pas nos offres spéciales!`,
    },
    es: {
        ...
        customer_title_6: `Colección Extensa`,
        customer_title_4: `Visite nuestra Tienda Outlet`,
        ...
        customer_description_6: `Nuestro portafolio incluye una amplia gama de estilos para todas las edades y preferencias. Actualizamos regularmente nuestro surtido para reflejar las últimas tendencias de la moda. ¡Encuentra tu look perfecto con nosotros!`,
        ...
        customer_description_4: `Visite nuestra tienda outlet para ofertas y descuentos exclusivos. Experimente nuestros productos de alta calidad de primera mano y encuentre grandes ofertas en sus estilos favoritos. ¡No se pierda nuestras ofertas especiales!`,
    },
    ua: {
        ...
        customer_title_6: `Обширна Колекція`,
        customer_title_4: `Відвідайте наш Магазин`,
        ...
        customer_description_6: `Наш портфель включає широкий асортимент стилів для всіх вікових груп і вподобань. Ми регулярно оновлюємо наш асортимент з урахуванням останніх модних тенденцій. Знайдіть свій ідеальний образ у нас!`,
        ...
        customer_description_4: `Відвідайте наш магазин для ексклюзивних пропозицій та знижок. Відчуйте нашу високоякісну продукцію на власному досвіді та знайдіть чудові пропозиції на ваші улюблені стилі. Не пропустіть наші спеціальні пропозиції!`,
    },
    pl: {
        ...
        customer_title_6: `Rozległa Kolekcja`,
        customer_title_4: `Odwiedź nasz Sklep Outlet`,
        ...
        customer_description_6: `Nasz portfolio obejmuje szeroką gamę stylów dla wszystkich grup wiekowych i preferencji. Regularnie aktualizujemy nasz asortyment, aby odzwierciedlał najnowsze trendy mody. Znajdź swój idealny wygląd u nas!`,
        ...
        customer_description_4: `Odwiedź nasz sklep outlet, aby uzyskać ekskluzywne oferty i rabaty. Wypróbuj nasze wysokiej jakości produkty osobiście i znajdź świetne okazje na swoje ulubione style. Nie przegap naszych specjalnych ofert!`,
    },
    cz: {
        ...
        customer_title_6: `Široká Kolekce`,
        customer_title_4: `Navštivte náš Outlet`,
        ...
        customer_description_6: `Náš portfolio zahrnuje širokou škálu stylů pro všechny věkové skupiny a preference. Pravidelně aktualizujeme náš sortiment, aby odrážel nejnovější módní trendy. Najděte svůj dokonalý vzhled u nás!`,
        ...
        customer_description_4: `Navštivte náš outlet pro exkluzivní nabídky a slevy. Vyzkoušejte naše vysoce kvalitní produkty na vlastní oči a najděte skvělé nabídky na své oblíbené styly. Nepropásněte naše speciální nabídky!`,
    },
    ru: {
        ...
        customer_title_6: `Обширная Коллекция`,
        customer_title_4: `Посетите наш Магазин`,
        ...
        customer_description_6: `Наш портфель включает широкий ассортимент стилей для всех возрастов и предпочтений. Регулярно обновляем наш ассортимент с учетом последних модных тенденций. Найдите свой идеальный образ у нас!`,
        ...
        customer_description_4: `Посетите наш магазин для эксклюзивных предложений и скидок. Испытайте нашу высококачественную продукцию лично и найдите отличные предложения на ваши любимые стили. Не пропустите наши специальные предложения!`,
    },
    kz: {
        ...
        customer_title_6: `Кең Коллекция`,
        customer_title_4: `Біздің Дүкенімізге Келіңіз`,
        ...
        customer_description_6: `Біздің портфолиоымыз барлық жас топтары мен талғамдарға арналған стильдердің кең ауқымын қамтиды. Біз өз ассортиментімізді соңғы сән трендтеріне сәйкес үнемі жаңартып отырамыз. Біздің қолымыздан сіздің мінсіз көрінісіңізді табыңыз!`,
        ...
        customer_description_4: `Эксклюзивті ұсыныстар мен жеңілдіктер үшін біздің дүкенімізге келіңіз. Біздің жоғары сапалы өнімдерімізді өз көзіңізбен көріп, сүйікті стильдеріңізге тамаша ұсыныстар табыңыз. Біздің арнайы ұсыныстарымызды жіберіп алмаңыз!`,
    },
};
