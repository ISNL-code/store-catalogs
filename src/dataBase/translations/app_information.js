export const APP_INFO = {
    en: {
        ...
        request_e_catalog_instruction: 'To request the Sales Nest E-Catalog, please visit our website.',
    ...
    fr: {
        ...
        request_e_catalog_instruction: 'Pour demander le E-Catalogue de Sales Nest, veuillez visiter notre site web.',
    ...
    es: {
        ...
        request_e_catalog_instruction:
            'Para solicitar el E-Catálogo de Sales Nest, por favor visita nuestro sitio web.',
    ...
    ua: {
        ...
        request_e_catalog_instruction: 'Щоб замовити E-Каталог Sales Nest, будь ласка, відвідайте наш веб-сайт.',
    ...
    pl: {
        ...
        request_e_catalog_instruction: 'Aby zamówić E-Katalog Sales Nest, odwiedź naszą stronę internetową.',
    ...
    cz: {
        ...
        request_e_catalog_instruction: 'Chcete-li požádat o E-Katalog Sales Nest, navštivte naše webové stránky.',
    ...
    ru: {
        ...
        request_e_catalog_instruction: 'Чтобы заказать E-Каталог Sales Nest, пожалуйста, посетите наш веб-сайт.',
    ...
    kz: {
        ...
        request_e_catalog_instruction: 'Sales Nest E-Каталогын сұрау үшін біздің веб-сайтымызға кіріңіз.',
