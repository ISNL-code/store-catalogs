    ...
    const langList = [
        ...
        },
        {
            ...
            string: {
                ...
                plan: 'Жоспар',
                comment: 'Пікір',
                owner_title_1: 'Қолжетімділікті арттыру',
                owner_title_2: 'Ыңғайлы басқару',
                owner_title_3: 'Сату тиімділігін арттыру',
                owner_title_4: 'Көптілділік',
                owner_title_5: 'Ішкі пайдалану',
                owner_description_1:
                    'Электронды каталог кез келген уақытта және кез келген жерден өнімдерді қол жетімді етеді, бұл көрермендердің кеңеюіне және сатылымның артуына әкелуі мүмкін.',
                owner_description_2:
                    'Өнім ассортиментін тез және тиімді басқаруға, ақпарат пен фотосуреттерді жаңартуға, сұраныстағы өзгерістерге жедел жауап беруге мүмкіндік береді.',
                owner_description_3:
                    'Себет функционалдығын интеграциялау тұтынушыларға тапсырыстарды оңай жинауға мүмкіндік береді, бұл өз кезегінде конверсияны және орташа тапсырыс мөлшерін арттырады.',
                owner_description_4:
                    'Бірнеше тілдерді қолдау әртүрлі елдерден келген тұтынушылармен жұмыс істеуді жеңілдетеді, каталогты халықаралық аудиторияға тартымды етеді.',
                owner_description_5:
                    'Каталог тек сату құралы ретінде ғана емес, сонымен қатар қызметкерлер арасындағы ішкі байланыс және үйлестіру құралы ретінде қызмет ете алады, оларға өнім туралы ақпаратты тез және оңай қол жетімді етеді.',
                customer_title_1: 'Ыңғайлылық және қолжетімділік',
                customer_title_2: 'Іздеу және салыстырудың оңайлығы',
                customer_title_3: 'Бөлшек және көтерме тапсырыстарды жинау үшін ыңғайлылық',
                customer_title_4: 'Көптілділік',
                customer_title_5: 'Қызмет көрсету деңгейін жақсарту',
                customer_description_1:
                    'Тұтынушыларға әрқашан және кез келген жерде интернет арқылы өнім ассортиментін іздеуге және шолуға мүмкіндік береді.',
                customer_description_2:
                    'Пайдаланушылар қызығушылығын тудыратын өнімдерді жылдам табу үшін ыңғайлы сүзгілерді және іздеуді пайдалана алады, сондай-ақ олардың сипаттамалары мен бағаларын салыстыра алады.',
                customer_description_3:
                    'Себет тұтынушыларға қажетті өнімдерді қажет кезінде қосу арқылы көтерме тапсырыстарды ыңғайлы түрде жасауға мүмкіндік береді, ірі көлемді сатып алу процесін жеңілдетеді.',
                customer_description_4:
                    'Бірнеше тілдің болуы каталогты кең аудитория үшін қолжетімді етеді, өнімдер мен қызметтер туралы ақпаратты түсінуге көмектеседі.',
                customer_description_5:
                    'Электрондық каталог өнімдер туралы толық ақпаратты, олардың бар-жоғын және бағаларын жылдам алу мүмкіндігін ұсынады, бұл сатып алу шешімдерін жасауға көмектеседі.',
